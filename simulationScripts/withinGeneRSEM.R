...
bitseq1 <- read.table("rsemA1.txt")[,3] 
nams <- read.table("rsemA1.txt")[,1]
...
bitseq1 <- read.table("rsemA2.txt")[,3] 
nams <- read.table("rsemA2.txt")[,1]
...
####
####
bitseq1 <- read.table("rsemA3.txt")[,3] 
nams <- read.table("rsemA3.txt")[,1]
...
#####
####
bitseq1 <- read.table("rsemA4.txt")[,3] 
nams <- read.table("rsemA4.txt")[,1]
...
###
####
bitseq1 <- read.table("rsemA5.txt")[,3] 
nams <- read.table("rsemA5.txt")[,1]
