...
close(myFile)
A1 <- read.table("A1.txt",header=TRUE)
...
write.table(sailA1,file = "tigarA1.txt")

A1 <- read.table("A2.txt",header=TRUE)
...
sailA1[,3] <- log(sailA1[,3]/sum(sailA1[,3]))
smoothScatter(sailA1[,-1]);points(c(-30,10),c(-30,10),type = "l",col = 2)
write.table(sailA1,file = "tigarA2.txt")

A1 <- read.table("A3.txt",header=TRUE)
...
sailA1[,3] <- log(sailA1[,3]/sum(sailA1[,3]))
smoothScatter(sailA1[,-1]);points(c(-30,10),c(-30,10),type = "l",col = 2)
write.table(sailA1,file = "tigarA3.txt")

A1 <- read.table("A4.txt",header=TRUE)
...
sailA1[,3] <- log(sailA1[,3]/sum(sailA1[,3]))
smoothScatter(sailA1[,-1]);points(c(-30,10),c(-30,10),type = "l",col = 2)
write.table(sailA1,file = "tigarA4.txt")

A1 <- read.table("A5.txt",header=TRUE)
...
sailA1[,3] <- log(sailA1[,3]/sum(sailA1[,3]))
smoothScatter(sailA1[,-1]);points(c(-30,10),c(-30,10),type = "l",col = 2)
write.table(sailA1,file = "tigarA5.txt")
