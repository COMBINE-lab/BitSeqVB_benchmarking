...
bitseq1 <- read.table("xpressA1.txt")[,3] 
nams <- read.table("xpressA1.txt")[,1]
...
bitseq1 <- read.table("xpressA2.txt")[,3] 
nams <- read.table("xpressA2.txt")[,1]
...
###########################
############################
bitseq1 <- read.table("xpressA3.txt")[,3] 
nams <- read.table("xpressA3.txt")[,1]
...
###########################
############################
bitseq1 <- read.table("xpressA4.txt")[,3] 
nams <- read.table("xpressA4.txt")[,1]
...
###########################
############################
bitseq1 <- read.table("xpressA5.txt")[,3] 
nams <- read.table("xpressA5.txt")[,1]
