...
bitseq1 <- read.table("sailA1.txt")[,3] 
nams <- read.table("sailA1.txt")[,1]
...
bitseq1 <- read.table("sailA2.txt")[,3] 
nams <- read.table("sailA2.txt")[,1]
...
bitseq1 <- read.table("sailA3.txt")[,3] 
nams <- read.table("sailA3.txt")[,1]
...
bitseq1 <- read.table("sailA4.txt")[,3] 
nams <- read.table("sailA4.txt")[,1]
...
bitseq1 <- read.table("sailA5.txt")[,3] 
nams <- read.table("sailA5.txt")[,1]
