...
bitseq1 <- read.table("tigarA1.txt")[,3] 
nams <- read.table("tigarA1.txt")[,1]
...
bitseq1 <- read.table("tigarA2.txt")[,3] 
nams <- read.table("tigarA2.txt")[,1]
...
########################
########################
bitseq1 <- read.table("tigarA3.txt")[,3] 
nams <- read.table("tigarA3.txt")[,1]
...
########################
########################
bitseq1 <- read.table("tigarA4.txt")[,3] 
nams <- read.table("tigarA4.txt")[,1]
...
########################
########################
bitseq1 <- read.table("tigarA5.txt")[,3] 
nams <- read.table("tigarA5.txt")[,1]
